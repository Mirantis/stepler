...
def test_restart_all_glance_services(cirros_image,
    ...
    **Teardown:**
    ...
    glance_steps.check_image_data(image_1, file_path_1)

    services = [config.GLANCE_API, config.GLANCE_GLARE, config.GLANCE_REGISTRY]
    os_faults_steps.restart_services(services)
    ...
    glance_steps.check_image_data(image_2, file_path_2)
