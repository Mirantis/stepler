...
def test_create_update_delete_image(glance_steps):
    """**Scenario:** Test to create / update / delete image.
    ...
    **Steps:**
    ...
    #. Delete image
    """
    params = {'min_ram': 512, 'min_disk': 1}
    image = glance_steps.create_images(
        utils.get_file_path(config.CIRROS_QCOW2_URL), **params)[0]

    params['min_ram'] = 1024
    glance_steps.update_images([image], **params)
