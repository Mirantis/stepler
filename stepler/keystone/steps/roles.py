...
class RoleSteps(BaseSteps):
    ...
    def get_role(self, *args, **kwgs):
        ...
        args, kwgs could be: any other attribute provided will be passed to
                the server, for example:
            name (str): the name of the role
            domain (obj): the domain of the role. If a value is passed it is a
    ...
    def grant_role(self,
        ...
        Args:
            role (str): the role to be granted on the server
