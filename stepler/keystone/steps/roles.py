...
class RoleSteps(BaseSteps):
    ...
    def get_role(self, *args, **kwgs):
        ...
        Args:
            name (str or obj): the name of the role
            domain (obj or obj): the domain of the role. If a value is passed
                it is a domain-scoped role, otherwise it's a global role
    ...
    def revoke_role(self,
        ...
        Args:
            ...
            user (str or obj): the specified user to have the role revoked on
                a resource. Domain or project must be specified.
                User and group are mutually exclusive.
            group (str or obj): the specified group to have the role revoked
                on a resource. Domain or project must be specified.
                User and group are mutually exclusive.
            domain (str or obj): the domain in which the role will be revoked.
                Either user or group must be specified. Project and domain
                are mutually exclusive.
            project (str or obj): the project in which the role will be
                revoked. Either user or group must be specified.
                Project and domain are mutually exclusive.
            check (bool): flag whether to check step or not
    ...
    def check_role_grant_status(self,
        ...
        Args:
            role (str or obj): the role to be checked on the server
            user (str or obj): the specified user to have the role checked on
                a resource. Domain or project must be specified.
                User and group are mutually exclusive.
            group (str or obj): the specified group to have the role checked
                on a resource. Domain or project must be specified.
                User and group are mutually exclusive.
            domain (str or obj): the domain in which the role will be checked.
                Either user or group must be specified. Project and domain
                are mutually exclusive.
            project (str or obj): the project in which the role will be
                checked. Either user or group must be specified.
                Project and domain are mutually exclusive.
            must_granted (bool): flag whether role should present or no
            timeout (int): seconds to wait a result of check
