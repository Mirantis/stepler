...
class TestAnyOne(object):
    ...
    @pytest.mark.idempotent_id('e41796c3-0f14-467c-80b0-98012d13bc1c',
                               any_one='user')
    def test_create_delete_security_group(self, security_groups_steps_ui):
        ...
        **Steps:**
        ...
        """
        group_name = security_groups_steps_ui.create_security_group()
        security_groups_steps_ui.delete_security_group(group_name)
    ...
    @pytest.mark.idempotent_id('108ae5e7-a61a-4fd7-a6fb-2109102fe899',
                               any_one='user')
    def test_add_delete_rule(self, security_groups_steps_ui, security_group):
        ...
        **Teardown:**
        ...
        """
        port_number = security_groups_steps_ui.add_group_rule(
            security_group.name)
        security_groups_steps_ui.delete_group_rule(port_number)
