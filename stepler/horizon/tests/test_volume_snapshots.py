...
class TestAnyOne(object):
    ...
    def test_create_volume_snapshot_with_long_name(self, volume,
        ...
        **Steps:**
            ...
            #. Check that snapshot name on snapshot creation form can contains
                max 255 symbols
        ...
        **Teardown:**
            ...
            #. Delete volume
        """
        volumes_steps.check_snapshot_creation_form_name_field_max_lenght(
            volume.name, 255)
    ...
    def test_create_volume_snapshot_with_max_length_description(
        ...
        **Teardown:**
        ...
        """
        snapshot_name = next(generate_ids('snapshot'))
        snapshot_description = next(generate_ids('snapshot'))
        snapshot_description = snapshot_description.ljust(255, 'a')
        create_snapshot(snapshot_name, description=snapshot_description)
