...
class SubnetManager(base.BaseNeutronManager):
    ...
    def create(self,
        ...
        Args:
            ...
            network_id (str): id of network to create subnet on it
            cidr (str): CIDR to create subnet with (like "10.0.0.0/24")
            ip_version (int): ip version (4 or 6)
            dns_nameservers (tuple of str): dns nameservers to subnet
            project_id (str|None): project id to create subnet on it. If None
                - subnet will create on current project
