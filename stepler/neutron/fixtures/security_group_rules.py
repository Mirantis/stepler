...
def get_security_group_rule_steps(get_neutron_client):
    ...
    def _get_steps(**credentials):
        return steps.SecurityGroupRuleSteps(
...
@pytest.fixture
def security_group_rule_steps(get_security_group_rule_steps):
    """Function fixture to get security group rule steps.

    Args:
        get_security_group_rule_steps (function): function to get instantiated
            security group rules steps

    Returns:
        stepler.neutron.steps.SecurityGroupRuleSteps: instantiated security
            group rules steps
    """
    return get_security_group_rule_steps()
