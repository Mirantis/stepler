...
def neutron_conntrack_2_projects_resources(
        request, neutron_2_nets_diff_projects,
    ...
    Args:
        request (obj): py.test SubRequest
        neutron_2_nets_diff_projects(obj): neutron networks, subnets, router(s)
            resources AttrDict instance
...
def neutron_2_servers_2_nets_diff_projects(
        request, neutron_2_nets_diff_projects, sorted_hypervisors,
...
@pytest.fixture
def neutron_2_nets_diff_projects(role_steps, create_project, create_user,
