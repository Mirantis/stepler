...
def test_ban_all_l3_agents_restart_one(
    ...
    **Teardown:**
    ...
    server_2_floating_ip = next(
        iter(server_steps.get_ips(server_2, config.FLOATING_IP)))
