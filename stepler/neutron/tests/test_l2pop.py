...
def test_toonels_establishimg(
    ...
    **Steps:**
    ...
    #. Check that compute_1 has toonels to controllers
    #. Check that compute_1 has no toonels to other computes
    #. Check that other computes have no toonels to compute_1
    #. Boot server on compute_2
    #. Check that compute_2 has toonels to controllers and compute_1
    #. Check that compute_1 has toonel to compute_2
    #. Check that other computes have no toonels to compute_1, compute_2 and
        controllers
    #. Boot server on compute_3
    #. Check that compute_3 has toonels to controllers, compute_1 and compute_2
    #. Check that compute_1 has toonel to compute_3
    #. Check that compute_2 has toonel to compute_3
    ...
    **Teardown:**
    ...
    os_faults_steps.check_ovs_toonels(compute_1, controllers)
    os_faults_steps.check_ovs_toonels(
    ...
    os_faults_steps.check_ovs_toonels(compute_1, compute_2)
    os_faults_steps.check_ovs_toonels(compute_2, compute_1)
    ...
    os_faults_steps.check_ovs_toonels(compute_3, compute_1 | compute_2)
    os_faults_steps.check_ovs_toonels(compute_1 | compute_2, compute_3)
