...
def test_update_router_from_centralized_to_distributed(
    ...
    **Teardown:**
    ...
    router_steps.update_router(router, {config.ROUTER_STATE_ATTR: False})
    router_steps.update_router(router, {config.ROUTER_DISTRIBUTED_ATTR: True})
    router_steps.update_router(router, {config.ROUTER_STATE_ATTR: True})
