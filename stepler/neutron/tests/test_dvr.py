...
def test_check_router_update_notification_for_l3_agents(
    ...
    **Steps:**
    ...
    #. Check that 3 notifications appear in log of L3 agent on one compute
    #. Check that no notification appear in log of L3 agent on other computes
    ...
    **Teardown:**
    ...
    main_node = os_faults_steps.get_node(fqdns=[server_host_name])
    os_faults_steps.check_string_in_file(
        main_node, file_name=log_file,
