...
def big_snapshot_quota(get_current_project, get_cinder_quota_steps):
    """Function fixture to increase cinder snapshots count quota.
...
def big_volume_quota(get_current_project, get_cinder_quota_steps):
    """Function fixture to increase cinder volumes count quota.
...
def big_backup_quota(get_current_project, get_cinder_quota_steps):
    """Function fixture to increase cinder backups count quota.
