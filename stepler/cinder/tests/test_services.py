...
def test_stop_nova_and_cinder_services(ubuntu_server,
    ...
    **Teardown:**
    ...
    os_faults_steps.terminate_service(config.CINDER_VOLUME)
    ...
    os_faults_steps.start_service(config.NOVA_COMPUTE)
    os_faults_steps.start_service(config.CINDER_VOLUME)
