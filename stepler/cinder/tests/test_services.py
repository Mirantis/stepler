...
def test_restart_all_cinder_services(volume,
    ...
    **Teardown:**
    ...
    with server_steps.get_server_ssh(server,
                                     proxy_cmd=proxy_cmd) as server_ssh:
        server_ssh.exe('mount /dev/vdb /mnt/volume1')
        server_ssh.exe('touch /mnt/volume1/test_file1')
    ...
    with server_steps.get_server_ssh(server,
                                     proxy_cmd=proxy_cmd) as server_ssh:
        server_ssh.exe('mount /dev/vdc /mnt/volume2')
        server_ssh.exe('cp /mnt/volume1/test_file1 /mnt/volume2/test_file2')
