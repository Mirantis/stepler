...
def test_negative_create_volume_non_exist_volume_type(create_image,
                                                      volume_steps):
    ...
    **Teardown:**
    ...
    image = create_image(image_name, config.CIRROS_QCOW2_URL)
    volume_steps.check_volume_not_created_with_non_exist_volume_type(image)
