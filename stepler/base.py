...
class BaseApiClient(object):
    ...
    def get(self, url, headers=None, params=None, **kwgs):
        headers = headers or {}
    ...
    def put(self, url, headers=None, data=None, **kwgs):
        headers = headers or {}
        headers.update(self._auth_headers)
    ...
    def post(self, url, headers=None, data=None, json=None, **kwgs):
        headers = headers or {}
        headers.update(self._auth_headers)
    ...
    def patch(self, url, headers=None, data=None, **kwgs):
        headers = headers or {}
        headers.update(self._auth_headers)
    ...
    def delete(self, url, headers=None, **kwgs):
        headers = headers or {}
        headers.update(self._auth_headers)
