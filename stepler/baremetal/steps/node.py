...
class IronicNodeSteps(BaseSteps):
    ...
    @step
    def create_node(self, driver='fake', check=True, **kwargs):
        """Step to create a node based on a kwargs dictionary of attributes.

        Parameters:
            :param driver: The name or UUID of the driver.
            :param check: For checking node presence
            :param  kwargs: Optional. A dictionary containing the attributes of the
