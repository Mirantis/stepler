...
from stepler.third_party import matchers
...
class IronicNodeSteps(BaseSteps):
    ...
    def check_ironic_node_presence(self,
        ...
        def predicate():
            ...
            return matchers.expect_that(is_present, equal_to(must_present))
    ...
    def set_ironic_node_maintenance(self,
        ...
        Args:
            ...
            maint_reason (str): Optional string. Reason for putting node
    ...
    def check_ironic_node_maintenance(self,
        ...
        def predicate():
            try:
                self._client.node.get(node_id=node.uuid)
                maintenance_is_changed = True
            except exceptions.NotFound:
                maintenance_is_changed = False

            return matchers.expect_that(maintenance_is_changed,
                                        equal_to(maintenance_must_changed))
