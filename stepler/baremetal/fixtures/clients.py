...
def get_api_ironic_client(get_session):
    ...
    return _get_api_ironic_client


@pytest.fixture
def ironic_client_v1(get_api_ironic_client):
    ...
    """
    return get_api_ironic_client(version='1', is_api=False)


@pytest.fixture
def api_ironic_client_v1(get_api_ironic_client):
    ...
    """
    return get_api_ironic_client(version='1', is_api=True)
