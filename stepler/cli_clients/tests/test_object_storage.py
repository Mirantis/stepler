...
def test_containers_list_contains_created_container(container_steps,
                                                    cli_swift_steps):
    """**Scenario:** Check container list contains created container.
        ...
        **Teardown:**
        ...
        #. Delete container
        """
    container = container_steps.create(name=utils.generate_ids('test'))
    cli_swift_steps.check_containers_list_contains(container)
