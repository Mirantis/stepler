...
def test_create_volume_using_image_name(images_cleanup, glance_steps,
                                        volumes_cleanup, cli_cinder_steps,
                                        volume_steps):
    ...
    **Teardown:**
    ...
    cli_cinder_steps.create_volume(name=volume_name, image=image.name)
