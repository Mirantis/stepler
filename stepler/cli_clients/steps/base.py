...
class BaseCliSteps(object):
    ...
    def __init__(self, client):
        """Base CLI steps constructor.

        Args:
            client (obj): os-faults initialized steps
    ...
    def execute_command(self,
        ...
        Args:
            ...
            environ (dict): shell environs to set before `cmd` executing
        ...
        """
        if use_openrc:
            source_cmd = "source " + config.OPENRC_FILE_PATH + ";"
        else:
            source_cmd = ""
