...
from hamcrest import assert_that, contains_string, is_not  # noqa H301
...
class CliNeutronSteps(base.BaseCliSteps):
    ...
    @steps_checker.step
    def create_router(self, name, project=None,
                      username=None, password=None,
                      distributed=None, check=True):
    ...
    def check_negative_router_create_with_distributed_option(
            self, name, project, username, password, distributed):
        ...
        """
        error_message = "disallowed by policy"
