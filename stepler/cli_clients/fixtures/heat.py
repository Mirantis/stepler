...
@pytest.fixture
def cli_heat_steps(run_os_cli_command):
    ...
    """
    return steps.CliHeatSteps(run_os_cli_command)


@pytest.yield_fixture
def empty_heat_template_path(nova_api_node, get_template_path,
                             os_faults_steps):
    ...
    Args:
        nova_api_node (obj): os-faults node
