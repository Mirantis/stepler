...
@pytest.fixture
def remote_executor(nova_api_node, os_faults_steps, resource_manager):
    ...
    def _execute_cli(cmd, use_openrc=True, environ=None, **kwargs):
        ...
        if use_openrc:
            ...
            current_credentials = resource_manager.current_credentials
            environ['OS_PROJECT_NAME'] = current_credentials.project_name
            environ['OS_TENANT_NAME'] = current_credentials.project_name
            environ['OS_USERNAME'] = current_credentials.username
            environ['OS_PASSWORD'] = current_credentials.password
        else:
            source_cmd = ""
