...
def test_rebuild_in_paused_state(cirros_image, server, server_steps):
    ...
    **Teardown:**
        ...
        #. Delete cirros image
    """
    server_steps.check_server_not_rebuilt_in_paused_state(server, cirros_image)
...
def test_rebuild_in_rescue_state(cirros_image, server, server_steps):
    ...
    **Teardown:**
        ...
        #. Delete cirros image
    """
    server_steps.check_server_not_rebuilt_in_rescue_state(server, cirros_image)
