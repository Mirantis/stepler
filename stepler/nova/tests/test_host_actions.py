...
def test_resources_info(cirros_image,
                        flavor,
                        network,
                        subnet,
                        keypair,
    ...
    **Teardown:**
        ...
        #. Delete cirros image
    """
    hypervisors = hypervisor_steps.get_hypervisors(min_number=2)
    ...
    usage_data_1_old = host_steps.get_usage_data(host_1)
    usage_data_2_old = host_steps.get_usage_data(host_2)

    server_names = utils.generate_ids(prefix='server', count=2)
    ...
    usage_data_1_new = host_steps.get_usage_data(host_1)
    host_steps.check_usage_difference(usage_data_1_old,
                                      usage_data_1_new,
                                      changed=True,
                                      project_id=servers[0].tenant_id)

    usage_data_2_new = host_steps.get_usage_data(host_2)
    host_steps.check_usage_difference(usage_data_2_old,
                                      usage_data_2_new,
                                      changed=False)
    ...
    usage_data_1_old = usage_data_1_new
    usage_data_1_new = host_steps.get_usage_data(host_1)
    host_steps.check_usage_difference(usage_data_1_old,
                                      usage_data_1_new,
                                      changed=False)

    usage_data_2_old = usage_data_2_new
    usage_data_2_new = host_steps.get_usage_data(host_2)
    host_steps.check_usage_difference(usage_data_2_old,
                                      usage_data_2_new,
                                      changed=True,
