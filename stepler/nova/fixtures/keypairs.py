...
def keypair_steps(nova_client):
    """Callable function fixture to get keypair steps.
...
def create_keypair(keypair_steps):
    ...
    Returns:
        function: function to create keypairs as batch with options
    """
    keypairs = []
...
def keypair(create_keypair):
    ...
    Returns:
        function: function to create keypair as batch with options
    """
