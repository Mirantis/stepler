...
def _clear_stayed_servers(server_steps):
    """Clear unexpected servers.

    We should clear servers before test, which unexpectedly stayed after tests.
...
def get_server_steps(get_nova_client):
    ...
    def _get_server_steps():
        ...
        _clear_stayed_servers(server_steps)
        return server_steps
