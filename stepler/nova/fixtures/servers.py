...
def live_migration_servers(request,
    ...
    This fixture create max allowed count of servers and add floating ip to
    each. It can boot servers from ubuntu image or volume with parametrization.
    Default is boot from image.

    All created resources will be deleted afetr test.
    ...
    Args:
        ...
        big_hypervisors (list): nova hypervisors list
    ...
    if boot_from_volume:
        ...
        volumes = volume_steps.create_volumes(size=20,
                                              image=ubuntu_image,
                                              names=volume_names)
