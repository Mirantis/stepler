...
FLAVOR_EXTRA_TINY = 'm1.extra_tiny'
FLAVOR_TINY = 'm1.tiny'
...
CONFIM_RESIZE_STATUS = 'Confirm or Revert Resize/Migrate'
...
BAREMETAL_NETWORK_DEVSTACK = 'private'
IRONIC_MULTITENANT_NETWORK = 'ironic-provision'
