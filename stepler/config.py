...
BAREMETAL_UBUNTU = 'http://172.18.162.84:8000/dib-user-image-dkms-grub.raw'
...
BAREMETAL_FUEL_DISK_INFO = [{"name": "sda", "extra": [], "free_space": 11000, "type": "disk", "id": "sda", "size": 11000, "volumes": [{"mount": "/", "type": "partition", "file_system": "ext4", "size": 10000}]}]  # noqa
