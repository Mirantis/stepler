...
class ContainerSteps(base.BaseSteps):
    ...
    def check_object_hash(self, created_object_name, downloaded_object_name):
        ...
        created_md5_1 = utils.get_md5sum(created_object_name)
        downloaded_md5_2 = utils.get_md5sum(downloaded_object_name)

        assert_that(created_md5_1, equal_to(downloaded_md5_2))
