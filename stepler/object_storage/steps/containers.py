...
class ContainerCephSteps(base.BaseSteps):
    ...
    @steps_checker.step
    def create(self, bucket_name, check=True):
        ...
        if check:
            self.check_radow_bucket_presence(bucket)
        return bucket
    ...
    def delete(self, bucket_name, check=True):
        ...
        if check:
            self.check_radow_bucket_presence(bucket_name, must_present=False)

    @steps_checker.step
    def check_radow_bucket_presence(self, bucket_name, must_present=True):
